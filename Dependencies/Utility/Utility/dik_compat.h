...
** dik_compat.h
**
** DirectInput DIK_ scan code constants for Emscripten builds.
** On Windows these come from <dinput.h>.  Here we define only the
** subset actually referenced by KeyDefs.h.
**
** Values match the DirectInput scan codes (identical to USB HID usage
** page 0x07 codes, which is also what browser KeyboardEvent.code maps to).
*/
